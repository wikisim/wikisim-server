...
The `main` branch of this repository will be deployed to Deno.land automatically.
Please inform us of any vulnerabilities in this branch using the private "[Report a vulnerability](https://github.com/wikisim/wikisim-server/security/advisories/new)".
...
To report this vulnerability please use the private "[Report a vulnerability](https://github.com/wikisim/wikisim-server/security/advisories/new)"
